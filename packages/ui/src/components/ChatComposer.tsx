...
/**
 * Basic chat composer with optional voice toggle.
 */
        ...
        <div className="flex items-center gap-2">
          {onVoiceToggle ? (
            <button
              ...
              className={clsx(
                'rounded-full border border-slate-700 px-3 py-1 text-xs transition-colors',
                isListening ? 'border-emerald-500 text-emerald-400' : 'hover:border-blue-500 hover:text-blue-300'
              )}
            >
